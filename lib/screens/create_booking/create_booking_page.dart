...
String hourlyFromPlaceId = '';
String fromPlaceId = '';
String toPlaceId = '';
String hourlyFromCoordinate = '';
...
class _CreateBookingPageState extends State<CreateBookingPage> {
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 24),
                    isTapOneway == 0 ? OnewayWidget() : HourlyWidget(),
                    ...
                    Padding(
                      ...
                      child: CustomButtons(
                        isIcon: false,
                        onTap: () async {
                          if (_checkingDistance) return;
                          if (isTapOneway == 0) {
                            final invalid =
                                fromController.text.isEmpty ||
                                toController.text.isEmpty ||
                                bookingDateController.text.isEmpty ||
                                bookingTimeController.text.isEmpty ||
                            ...
                            if (invalid) {
                              ...
                              setState(() => _checkingDistance = true);
                              ...
                              try {
                                ...
                                if (mounted) {
                                  rootNav.pop();
                                  setState(() => _checkingDistance = false);
                                }
                              }
                              if (!mounted) return;
                              if (km == null) {
                            ...
                            final invalid =
                                hourlyFromController.text.isEmpty ||
  ...
  showRouteNotFoundDialog(BuildContext context) {
    return showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            'No route distance found for selected pickup and drop-off locations.',
          ),
          actions: [
            TextButton(
